...
printf "  \e[101m\e[1;77m ;;ZONA KOMUNITAS PEMBERANTAS KEMAKSIATAN::\e[0m\n"
...
echo -e $bu  " Tools       : KPK-TOOL$white          " 
echo -e $bu  " Author      : BLACKHAT  INDONESIAetc$white  " 
echo -e $bu  " Contact     : 083824119***$white " 
...
ctrl_c() {
clear
echo -e $red"~~> Ga usah sombong,gunakan dengan bijak gaesss  ... "
echo -e $cyan".."
sleep 1
echo ""
echo -e $r"..."
...
echo -e $g"    [ 6] Hack fb target 30%${endc}";
